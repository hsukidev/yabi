...
/**
 * Roster-level Black Mage Monthly meso for an already world-lensed mule list.
 ...
 */
export function blackMageMonthlyMesoForRoster(mulesInWorld: readonly Mule[]): number {
