...
all pointing at the existing `public/og-preview.png` (1280×908, served at
`https://yabi.henesys.io/og-preview.png`).
...
- **Dedicated 1200×630 OG card image.** Current `og-preview.png` (1280×908)
